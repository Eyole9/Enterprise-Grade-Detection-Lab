...
![Windows authentication events](screenshots/4624-4625-windows-authentication-events.png)
...
![Brute-force alert configuration](screenshots/brute-force-alert-configuration.png)

Shows the saved Splunk alert configured to identify failed-to-successful authentication patterns.

## Process-Creation Search

![Process creation search](screenshots/4688-process-creation-search.png)
...
![Expanded process event](screenshots/4688-expanded-process-event.png)

Shows detailed process-creation information from an expanded Windows Event ID 4688.

## Scheduled-Task Creation

![Scheduled task event](screenshots/4698-scheduled-task-event-details.png)
...
![Audit policy change overview](screenshots/4719-audit-policy-change-overview.png)

Shows Event ID 4719 search results confirming that audit-policy changes were ingested into Splunk.

![Audit policy change details](screenshots/4719-audit-policy-change.png)

Shows additional Event ID 4719 details from the controlled audit-policy modification.

## Local User Creation

![Local user creation](screenshots/4720-local-user-created.png)
...
![Group membership change](screenshots/4732-group-membership-event-overview.png)
...
![Security group management auditing](screenshots/audit-security-group-management-enabled.png)
